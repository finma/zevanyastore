            ...
            <div className="inline-block relative text-left">
              <div>
                ...
                >
                  ...
                  <span className="ml-1 text-base">Hallo, {user.name.split(" ")[0]}</span>
                </button>
              </div>
              {isOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-md ring-1 ring-black ring-opacity-5 shadow-lg origin-top-right">
                  <div className=" py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                    ...
                    <button
                      ...
                      className="py-2 px-4 w-full text-left text-gray-700 hover:text-pastel-pink dark:text-gray-100 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-600"
                      role="menuitem"
                    >
                      <span className="flex space-x-2">
                        <svg
